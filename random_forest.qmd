...
#figure(
  table(
    ...
    table.header(
      table.cell(colspan: 2, "Hyperparamètre"),
      [Description]
    ),
    [#text(box(image("./icons/logo-R.svg", height:2em))) \ `ranger`],
    [#text(box(image("./icons/logo-python2.svg", height:2em))) \ `scikit-learn`],
    [],
...
#table(
  align: center,
  columns: 3,
  // First row (default alignment)
  [ "Header 1", "Header 2", "Header 3" ],
  // Second row (centered)
  align(center)[ "Cell 1"],
  align(center)[ "Cell 2"],
  align(center)[ "Cell 3"],
  // Third row (default alignment)
