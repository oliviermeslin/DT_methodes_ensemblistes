...
# Introduction
Cette section comporterait environ 1 page et détaillerait les objectifs du document et les différents niveaux de lecture (aperçu, détail formalisé, guide d'usage, cas d'usage).
