...
## Pourquoi (et quand) le Bagging fonctionne
...
$E_L[(Y - \phi(x, L))^2] = \underbrace{(E_L[\phi(x, L)] - Y^2}_{\text{Biais}^2} + \underbrace{E_L[(\phi(x, L) - E_L[\phi(x, L)])^2]}_{\text{Variance}}$
