...
Les forêts aléatoires sont relativement moins "tunables" que d'autres algorithmes, mais un léger gain de performance est possible en optimisant les hyperparamètres. C'est plutôt un avantage en pratique: les hyperparamètres par défaut fournissent le plus souvent une forêt aléatoire relativement performante, et il n'est pas forcément utile de passer beaucoup de temps à les optimiser.
