...
Attention présentation détaillée

Bien préciser que cette approche permet de construire des forêts aléatoires et des modèles de _boosting_. Il existe de multiples implémentations du _gradient boosting_ (GBM, lightGBM, XGBoost, Catboost...). L'exposé qui suit reprend les notations de l'article qui a introduit XGBoost (2016).
...
- La gestion des variables continues (quantization par histogram);
