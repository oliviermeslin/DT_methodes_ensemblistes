...
//   // align: (x, y) => if x == 1 and y >= 1 { left } else { center },
//   align: (x, y) => (
//     // Separate black cells with white strokes.
//     left: if y == 0 { rgb(center) } else { left },
//     rest: left,
//   stroke: (x, y) => (
//     // Separate black cells with white strokes.
//     left: if y == 0 and x > 0 { rgb("FF0000") } else { black },
//     rest: black,
...
| `max_cat_threshold`                                                 | Nombre maximal de catégories considérées                                    | A COMPLETER       |

: Les hyperparamètres d'XGBoost {tbl-colwidths="[25,60,15]"}
