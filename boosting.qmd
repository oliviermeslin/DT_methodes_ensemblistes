...
- Dans une forêt aléatoire, chaque arbre constitue un modèle à part entière (bien que souvent peu performant), ce qui signifie qu'il peut être utilisé, représenté et interprété indépendamment des autres arbres. Dans un modèle de _boosting_, chaque arbre n'a pas aucun sens indépendamment de l'ensemble des arbres qui l'ont précédé dans l'entraînement.
